...
.success-header { background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white; padding: 2rem; border-radius: 12px; text-align: center; margin: -2.5rem -2.5rem 2rem -2.5rem; }
.success-header h1 { font-size: 2rem; font-weight: 700; }
