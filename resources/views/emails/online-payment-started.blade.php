...
<head>
    ...
    <title>Płatność online — zamówienie #{{ $order->id }}</title>
</head>
...
<tr><td style="padding: 40px 48px;">
    ...
    <p style="margin: 0 0 16px;">otrzymujesz tę wiadomość, ponieważ rozpocząłeś płatność online za szkolenie:</p>
    ...
    <p style="margin: 0 0 24px;">Jeśli płatność nie została dokończona, możesz wrócić do bramki płatności lub wybrać fakturę z odroczonym terminem płatności.</p>
    ...
    <tr><td style="padding: 20px 24px;">
        <p style="margin: 0 0 12px;">Przejdź do płatności:</p>
        ...
        <p style="margin: 0 0 8px; font-size: 14px; color: #555;">Alternatywnie:</p>
        <p style="margin: 0;">
