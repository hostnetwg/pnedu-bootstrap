            ...
            <div id="v2-recipient-section" @if($profile === 'person') hidden @endif>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-lg-7" id="v2-recipient-internal-wrap" @if($recipientIdType !== 'internal') hidden @endif>
                        ...
                        <input class="form-control @error('recipient_internal_id') is-invalid @enderror" id="recipient_internal_id" name="recipient_internal_id" value="{{ $field('recipient_internal_id') }}" maxlength="20" autocomplete="off" placeholder="np. 1234567890-00001" @disabled($recipientIdType !== 'internal')>
                        <div class="form-text">Dla oddziału lub jednostki wewnętrznej nabywcy wpisz pełny identyfikator z KSeF, np. 1234567890-00001.</div>
