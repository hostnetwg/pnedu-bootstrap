...
- `GET|POST /kursy/{product:slug}/zamowienie` — checkout płatnych wariantów w 4 krokach jak szkolenie V2 (profil → kontakt → faktura → płatność); nowy zakup startuje od „Osoba prywatna” i płatności online, gdy bramka jest dostępna; przy osobie prywatnej przełącznik „Zamawiający jest równocześnie uczestnikiem kursu” kopiuje imię, nazwisko i e-mail do uczestnika oraz nabywcy na fakturze; jeden wariant jest w podsumowaniu, nie jako osobny krok,
